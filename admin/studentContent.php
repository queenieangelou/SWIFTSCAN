    ...
    <?php
        ...
        WHERE
            ...
            if ($studentInfo && is_array($studentInfo)) {
                ...
                echo '<td>No department information</td>';
            }
            // End of displaying Year and Section information
            echo '<td><a href="delete_student.php?id=' . $student['studid'] . '"><img src="../trash.svg" alt="Delete" style="width: 20px; height: 20px; color: red;"></a></td>';
            echo '<td><a href="edit_student.php?id=' . $student['studid'] . '"><img src="../edit.svg" alt="Edit" style="width: 20px; height: 20px; color: green;"></a></td>';
            echo '</tr>';
